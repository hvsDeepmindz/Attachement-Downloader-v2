  ...
  return (
    <>
      <button
        ...
        hover:opacity-[0.8] flex items-center justify-center gap-[1rem] border-[1px] border-[#8C8C8C] max-xl:border-white`}
      >
        <img src={btnImg} alt="btnImg" className="w-[20px] h-[20px] object-cover" />
        <p className={`text-[1.8rem] font-normal text-[#5E5E5E] max-xl:text-white`}>{btnTitle}</p>
      </button>
    </>
  );
};
