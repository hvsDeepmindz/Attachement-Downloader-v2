...
const AttachmentsMain = () => {
  const { handleAttachmentClick, attachmentFolderData } = Handlers();
        ...
        {attachmentFolderData.map((ele) => (
          ...
          >
            <div className="w-auto h-auto flex items-center justify-center bg-[#F1EFF8] px-[1rem] py-[1rem] rounded-xl">
              ...
              {/* If you want to use icon from API:
              <img src={ele.icon} alt="icon" className="w-[40px] h-[40px] object-cover" /> */}
            </div>
